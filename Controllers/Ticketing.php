...
use packages\ticketing\{Authentication, Authorization, Controller, Department, Events, Logs, Products, Ticket, TicketFile, TicketMessage, TicketParam, View, Views};
...
class Ticketing extends Controller {
	...
	public function message_delete($data){
		$view = View::byName(\packages\ticketing\Views\MessageDelete::class);
	...
	public function message_edit($data){
		$view = View::byName(\packages\ticketing\Views\MessageEdit::class);
	...
	public function unlock($data){
		$view = View::byName(\packages\ticketing\Views\Unlock::class);
	...
	public function delete($data){
		$view = View::byName(\packages\ticketing\Views\Delete::class);
	...
	public function confirmClose(array $data){
		...
		$ticket->client = new User($ticket->data['userpanel_users']);
		unset($ticket->data['userpanel_users']);
		$view = View::byName(\packages\ticketing\Views\Close::class);
		$view->setTicket($ticket);
		$this->response->setStatus(true);
		$this->response->setView($view);
		return $this->response;
	...
	public function confirmInProgress(array $data){
		...
		$ticket->client = new User($ticket->data['userpanel_users']);
		unset($ticket->data['userpanel_users']);
		$view = View::byName(\packages\ticketing\Views\Inprogress::class);
		$view->setTicket($ticket);
		$this->response->setStatus(true);
		$this->response->setView($view);
		return $this->response;
