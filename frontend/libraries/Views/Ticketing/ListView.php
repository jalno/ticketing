...
use packages\base\{View\Error, Views\Traits\Form, Translator, HTTP};
...
use packages\ticketing\{Authentication, Authorization, Ticket, Views\TicketList as TicketListView};
