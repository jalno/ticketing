	...
	<div class="col-md-12">
		...
		<form action="<?php echo userpanel\url('ticketing/lock/'.$this->getTicketData()->id); ?>" method="POST" role="form" class="form-horizontal">
			<div class="alert alert-block alert-warning fade in">
				<h4 class="alert-heading"><i class="fa fa-exclamation-triangle"></i> <?php echo t('ticket.lock.warning.title'); ?>!</h4>
				<p>
					<?php echo t('ticket.lock.warning', ['ticket.id' => $this->getTicketData()->id]); ?>
				</p>
				<p>
					...
					<button type="submit" class="btn btn-yellow"><i class="fa fa-ban tip"></i> <?php echo t('ticketing.lock'); ?></button>
				</p>
			</div>
		</form>
