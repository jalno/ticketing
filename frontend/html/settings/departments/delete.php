	...
	<div class="col-md-12">
		...
		<form action="<?php echo userpanel\url('settings/departments/delete/'.$this->getDepartmentData()->id); ?>" method="POST" role="form" class="form-horizontal">
			<div class="alert alert-block alert-warning fade in">
				...
				<p>
					<?php echo t('department.delete.warning', ['department_id' => $this->getDepartmentData()->id]); ?>
				</p>
				<p>
					...
					<button type="submit" class="btn btn-danger"><i class="fa fa-trash-o tip"></i> <?php echo t('department.delete'); ?></button>
				</p>
			</div>
		</form>
