...
<div class="panel panel-default">
	...
	<?php echo t('titles.ticketing.templates.add'); ?>
	...
	<div class="panel-body">
		<form id="templates-add-edit-form" action="<?php echo url('settings/ticketing/templates/add'); ?>" method="POST">
			<div class="row">
				<div class="col-sm-6">
				<?php
                $this->createField([
			...
			<div class="col-lg-4 col-md-5 col-sm-6 col-xs-12 col-lg-offset-8 col-md-offset-7 col-sm-offset-6">
				<div class="row">
					<div class="col-sm-6 col-xs-12">
						<button type="submit" form="templates-add-edit-form" class="btn btn-block btn-success">
